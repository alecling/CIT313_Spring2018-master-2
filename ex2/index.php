...
$register = new RegisteredUser('alecling','Regular User');
$admin = new Admin('alclingerman','Administrator');

$register->first_name = 'Alexa';
$register->last_name = 'Clingerman';
$register->email_address = 'aleclung@iupui.edu';

$admin->first_name = 'Cindy';
$admin->last_name = 'Clingerman';
...
<html>
<head>
    <title>CIT313 - Exercise 2 - alexa Clingerman</title>
</head>
<body>
<?php
